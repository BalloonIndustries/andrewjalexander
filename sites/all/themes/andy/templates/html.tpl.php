...
<head profile="<?php print $grddl_profile; ?>">
  <?php print $head; ?>
  <link href='http://fonts.googleapis.com/css?family=Open+Sans:400,300,800|Holtwood+One+SC' rel='stylesheet' type='text/css'>
  <title><?php print $head_title; ?></title>
  <?php print $styles; ?>
  <?php print $scripts; ?>
  <meta name="google-site-verification" content="cAFXICe_sFPQEcp5sDz3Y2O5_tfsXoXvq9vPWXVsl6Y" />
</head>
