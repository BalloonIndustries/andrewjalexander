    ...
    Drupal.behaviors.andy = {
        attach: function (context, settings) {
            if (typeof window.orientation === "undefined") {
                ...
                $(this).closest('.views-row').find(".page-projects .view-projects .views-field-title a").addCSS('color', '#B51F24');
                $(this).closest('.views-row').find(".page-projects .view-projects .views-field-title a").addCSS('text-shadow', '-1px -1px 0 #000, 1px -1px 0 #000, -1px 1px 0 #000, 1px 1px 0 #000');
