...
class FaxHistoryApi extends ApiClient
{
	...
	*/
	public function ListSentFaxes($current_page = 1, $items_per_page = 20)
	{
		return $this->CallApi('FaxHistory/ListSentFaxes',array('current_page' => $current_page, 'items_per_page' => $items_per_page),false);
	}
