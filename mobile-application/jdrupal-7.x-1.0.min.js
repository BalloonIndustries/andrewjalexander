...
case "m":var h=""+(c.getMonth()+1);1==h.length&&(h="0"+h);d+=h;break;case "Y":d+=c.getFullYear();break;case "H":var k=""+c.getHours();1==k.length&&(k="0"+k);d+=k;break;case "i":var l=""+c.getMinutes();1==l.length&&(l="0"+l);d+=l;break;default:d+=f}}return d}catch(m){console.log("date - "+m)}}
function dpm(a,b){try{a?"function"===typeof parent.window.ripple?"undefined"!==typeof b&&!1==b?console.log(JSON.stringify(a)):console.log(a):"object"===typeof a?console.log(JSON.stringify(a)):console.log(a):""==a?console.log("<empty-string>"):console.log("<null>")}catch(c){console.log("dpm - "+c)}}function drupal_user_defaults(){return{uid:"0",roles:{1:"anonymous user"},permissions:[]}}
...
console.log("200 - OK");e=null;var h=b.getResponseHeader("Content-Type");-1==h.indexOf("application/json")?(console.log("Drupal.services.call - ERROR - response header was "+h+" instead of application/json"),console.log(b.responseText)):e=JSON.parse(b.responseText);module_invoke_all("services_request_pre_postprocess_alter",a,e);a.success(e);module_invoke_all("services_request_postprocess_alter",a,e);module_invoke_all("services_postprocess",a,e)}else{Drupal.settings.debug&&(console.log(d+": "+c+" - "+
g),console.log(b.responseText),console.log(b.getAllResponseHeaders()));b.responseText?console.log(b.responseText):dpm(b);if("undefined"!==typeof a.error){var k=b.responseText||"";k&&""!=k||(k=g);a.error(b,b.status,k)}module_invoke_all("services_postprocess",a,b)}}else console.log("Drupal.services.call - request.readyState = "+b.readyState)}catch(l){Drupal.settings.debug&&(console.log(d+" (ERROR): "+c+" - "+g),console.log(b.responseText),console.log(b.getAllResponseHeaders())),console.log("Drupal.services.call - onload - "+
l)}};services_get_csrf_token({debug:a.debug,success:function(e){try{var g=!0;"undefined"!==typeof a.async&&!1===a.async&&(g=!1);b.open(d,c,g);g=null;"POST"==d?(g="application/json","user"==a.service&&"login"==a.resource&&(g="application/x-www-form-urlencoded")):"PUT"==d&&(g="application/json");a.contentType&&(g=a.contentType);g&&b.setRequestHeader("Content-type",g);e&&b.setRequestHeader("X-CSRF-Token",e);"undefined"!==typeof a.data?(Drupal.settings.debug&&(e=!0,"user"==a.service&&in_array(a.resource,
["login","create","update"])&&(e=!1),e&&("object"===typeof a.data?console.log(JSON.stringify(a.data)):console.log(a.data))),b.send(a.data)):b.send(null)}catch(h){console.log("Drupal.services.call - services_get_csrf_token - success - "+h)}},error:function(b,c,d){try{console.log("Drupal.services.call - services_get_csrf_token - "+d),a.error&&a.error(b,c,d)}catch(e){console.log("Drupal.services.call - services_get_csrf_token - error - "+e)}}})}else a.error(null,null,"Set the site_path and endpoint on Drupal.settings!")}catch(e){console.log("Drupal.services.call - error - "+
e)}};
...
"&");"undefined"!==typeof a.page_size&&(b+="page_size="+encodeURIComponent(a.page_size)+"&");return b.substring(0,b.length-1)}catch(h){console.log("entity_index_build_query_string - "+h)}}function _entity_wrap(a,b){try{var c={};"taxonomy_term"==a||"taxonomy_vocabulary"==a||"user"==a||-1!=a.indexOf("commerce")?c=b:c[a]=b;return c}catch(d){console.log("_entity_wrap - "+d)}}
